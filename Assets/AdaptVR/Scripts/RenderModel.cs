...
namespace AdaptVR
{
    ...
    {
        internal bool displayHandByDefault;
        internal bool displayControllerByDefault;
        Vector3 position;
        Quaternion rotation;

        internal void SetAnimationState(int stateValue)
        {
...
Debug.LogWarning("Not implemented");
        ...
        // }
        internal void SetControllerVisibility(bool v, bool permanent)
        {
            //throw new NotImplementedException();
Debug.LogWarning("Not implemented");
        }

        internal void SetHandVisibility(bool v, bool permanent)
        {
            //throw new NotImplementedException();
Debug.LogWarning("Not implemented");
        }
...
Debug.LogWarning("Not implemented");
        ...
        internal void MatchHandToTransform(Transform transform)
        {
            //throw new NotImplementedException();
Debug.LogWarning("Not implemented");
        }

        internal bool IsControllerVisibile()
        {
            //throw new NotImplementedException();
Debug.LogWarning("Not implemented");
            return true;
        ...
        internal Vector3 GetControllerPosition(string controllerHoverComponent)
        {
            //throw new NotImplementedException();
            Debug.LogWarning("Not implemented");
            return position;
        ...
        internal Quaternion GetHandRotation()
        {
            //throw new NotImplementedException();
            Debug.LogWarning("Not implemented");
            return rotation;
        ...
        internal void SetHandRotation(Quaternion targetHandRotation)
        {
            //throw new NotImplementedException();
            Debug.LogWarning("Not implemented");
        ...
        internal void SetHandPosition(Vector3 targetHandPosition)
        {
            //throw new NotImplementedException();
            Debug.LogWarning("Not implemented");
            position = targetHandPosition;
        }

        // internal void SetSkeletonRangeOfMotion(EVRSkeletalMotionRange oldRM_rom)
        // {
        //     //throw new NotImplementedException();
        //     Debug.LogWarning("Not implemented");
        // }
